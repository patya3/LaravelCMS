            ...
            <div class="card-content">
                ...
                <form action="{{route('register')}}" method="post" role="form">
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input class="input {{$errors->has('name') ? 'is-danger' : ''}}" type="text" name="name" id="name" placeholder="Joska Pista" value="{{old('name')}}" required>
                        </p>
                        @if ($errors->has('name'))
                    ...
                    <button class="button succes is-succes is-outlined is-fullwidth m-t-30">Register</button>
                </form>
