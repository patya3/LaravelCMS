            ...
            <div class="card-content">
                ...
                <form action="{{route('login')}}" method="post" role="form">
                    ...
                    <div class="field">
                        ...
                        <p class="control">
                            <input class="input {{$errors->has('password') ? 'is-danger' : ''}}" type="password" name="password" id="password" placeholder="name@example.com">
                        </p>
                    ...
                    <button class="button succes is-succes is-outlined is-fullwidth m-t-30">Log in</button>
                </form>
