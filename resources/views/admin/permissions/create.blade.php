        ...
        <form action="{{route('permissions.store')}}" method="POST">
          ...
          <div class="block">
            <b-radio-group v-model="permissionType">
              <b-radio name="permission_type" value="basic">Basic Permissions</b-radio>
              <b-radio name="permission_type" value="crud">CRUD Permissions</b-radio>
            </b-radio-group>
          </div>
          ...
          <div class="field" v-if="permissionType == 'basic'">
            ...
            <p class="control">
              <input type="text" class="input fa-calendar" name="display_name" id="display_name">
            </p>
          </div>
    ...
    var app = new Vue({
      ...
      methods: {
        ...
        crudSlug: function(item) {
          item.toLowerCase() + "-" + app.resource.toLowerCase();
        },
